                    ...
                    <Flex alignItems="start" flexWrap="wrap">
                        ...
                        <Box className="fromLeft" w={isLargerThan1000 ? "75%" : "100%"}>
                            <Text mb="3rem" textAlign="justify" lineHeight={7}>
                                I&apos;m a full-stack developer with a passion for building smart, responsive, and impactful digital experiences. My core stack includes Next.js, Flutter, and Django, giving me the flexibility to create both powerful web applications and sleek mobile apps. I specialize in crafting clean UIs using Tailwind CSS, Chakra UI (v3), and CSS-in-JS solutions, ensuring that every interface looks great and functions seamlessly across devices.

                                From developing secure transaction systems with user authentication and admin approval workflows, to designing dynamic church websites with live streaming, donation portals, calendars, and rich content pages—I focus on solving real problems with scalable, user-friendly solutions. I&apos;ve also worked with RESTful APIs and understand the importance of clean data flow and backend logic.

                                I use WSL to streamline my development process and integrate well with tools across platforms. My backend projects are powered by Django, allowing me to build reliable CMS features and manage complex data models efficiently.

                                Beyond coding, I care deeply about ethical practices in tech. I believe that integrity, accountability, and the human side of technology are just as important as writing efficient code. This mindset guides how I work, learn, and grow in the industry.

                                I&apos;m constantly evolving—always learning, always building, and always looking for meaningful ways to bring ideas to life through code.
                            </Text>
                            <Flex alignItems="center" justifyContent="space-between" gap={3} mb="1rem" flexWrap="wrap">
                                <Box lineHeight={10}>
                                    <Flex>
